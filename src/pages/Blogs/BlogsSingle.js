...
import image from '../../assests/blogs/blog3.jpg'
import image1 from '../../assests/user/pic1.jfif'
const BlogsSingle = () => {
    return (
        <div>
            <section class="text-gray body-font overflow-hidden">
                <div class="container px-12 py-24 mx-auto">
                    <div class="lg:w-full mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 class="text-sm title-font text-gray tracking-widest">BRAND NAME</h2>
                            ...
                            <div class="flex">
                                ...
                                <section class="text-gray body-font">
                                    <h2 class="text-sm title-font text-gray-500 tracking-widest">COMENTS</h2>

                                    <div class="container px-5 ">
                                        <div class=" w-full mx-auto text-center mt-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class=" w-4 h-4 text-gray " viewBox="0 0 975.036 975.036">
